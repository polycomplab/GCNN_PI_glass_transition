...
checkpoints_dir = 'checkpoints/finetune/copy_finetuned_on_PI_exp_old_after_pretrained_on_1000mols_without_fixed_split/'
...
results_save_path = f'{checkpoints_dir}preds_on_normalized_smiles_PI_exp_new_trained_on_PI_exp_old.csv'
