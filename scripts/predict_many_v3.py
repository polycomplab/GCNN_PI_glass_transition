...
for checkpoint_name in sorted(os.listdir(checkpoints_dir)):
    ...
    # old_ids, old_smiles = zip(*old_ids_smiles)
    new_old_ids, new_smiles = zip(*new_ids_smiles)
    ...
    with torch.no_grad():
        for i, data in enumerate(old_dataset_loader):
            ...
            # TODO match by normalized_smiles: smiles->rdkit_mol->normalized_smiles
            # Done in predict_many_v4
...
results_save_path = f'{checkpoints_dir}preds_on_PI_exp_old_after_trained_on_PI_exp_new_07_03_2023.csv'
