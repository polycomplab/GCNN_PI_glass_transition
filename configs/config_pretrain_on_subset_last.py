...
# dataset_name = 'PA_syn'
dataset_name = 'PI_syn_subset_1K_for_pretrain'
...
batch_size = 16  # effective batch size is this * 4 due to gradients accumulation
seed = 12
device_index = 9
...
if pretrain.state:
    ...
    milestone = int(pretrain.epochs*(5/6))  # to keep it 50 for 60 epochs
    pretrain.scheduler_params = {"milestones": [milestone], "gamma": 0.5}
    # total_num_batches = (subset * pretrain.epochs) // batch_size
    # pretrain.val_freq = 1000
    # pretrain.val_freq = total_num_batches // 10
    pretrain.val_freq = 25
    ...
    pretrain.num_batches_acc = 1  # number of batches to accumulate gradient over
    pretrain.subset = subset
    # pretrain.test_subset_size = 6400
    pretrain.test_subset_size = 200
