...
# prefix = 'round_78'#_really_old_PI_exp_db'
prefix = 'round_81'#_really_old_PI_exp_db'
...
dataset_path = "datasets/PI_syn_subset_1K_for_finetune"
...
if finetune.state:
    ...
    # finetune.dataset = SynteticDataset(
    #     root=dataset_path,
    #     target_name=finetune.target_name)

    finetune.epochs = epochs

    finetune.val_freq = 25

    finetune.save_preds = True
    finetune.test_subset_size = 200
