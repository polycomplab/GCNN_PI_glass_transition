...
if pretrain.state:
    ...
    pretrain.dataset = ExperimentalDataset(root=dataset_path, target_name=target_name)
 
    pretrain.pretrained_weights = ('checkpoints/finetune/copy_pretrained_on_100K_PI_syn_2_epochs/'
                                   '100_epochs_lr_0.0006_subset_size_100000_round_66_PI_syn_subset_100K'
                                   'finetuning on PI_syn_subset_100K#Sun Oct 29 22:11:24 2023_simple_subset_93600_epoch_2.pth')
