...
pretrains = {
        ...
        '100K_new_pretrain': ('100K_new_pretrain', '100_epochs_lr_0.0006_subset_size_100000_round_66_PI_syn_subset_100Kfinetuning on PI_syn_subset_100K#Sun Oct 29 22:11:24 2023_simple_subset_93600_epoch_2.pth'),
...
prefix = 'round_70'#_really_old_PI_exp_db'
...
# dataset_path = "datasets/PI_Syn_subset_1K"
