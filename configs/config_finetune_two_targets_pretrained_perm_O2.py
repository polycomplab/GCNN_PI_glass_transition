...
dataset1_path = "datasets/PA_exp_perm_O2"
...
name = f"{num_task_specific_layers}_task_specific_layers_" + name
...
model = KGNNModel(num_targets=2, num_task_specific_layers=num_task_specific_layers)
