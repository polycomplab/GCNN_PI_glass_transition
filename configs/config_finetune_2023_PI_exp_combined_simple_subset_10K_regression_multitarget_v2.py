...
# prefix = 'round_90'#_really_old_PI_exp_db'
# prefix = 'round_93'#_really_old_PI_exp_db'
# prefix = 'round_105'#_really_old_PI_exp_db'
# prefix = 'round_130'#_really_old_PI_exp_db'
# prefix = 'round_261'
# prefix = 'round_262'  # doesn't matter anymore
prefix = 'round_263'  # doesn't matter anymore
...
# dataset_path = "datasets/PI_syn_subset_10K"
# dataset_path = "datasets/PI_syn"

# dataset_path = "datasets/PI_syn_all_targets"  # NOTE !!!
# dataset_path = "datasets/PA_syn_all_targets"
...
multitarget = True  # NOTE
finetune_exp = True  # NOTE ! TODO change to something sane

# eval_only = True  # NOTE

# NOTE
checkpoints_dir = "checkpoints/multi_target_lr1e-4"
# checkpoints_dir = "checkpoints/multi_target_PA"
import os
...
# model = KGNNModel(dropout_p=dropout_p, num_targets=6, num_task_specific_layers=2)
model = KGNNModel(dropout_p=dropout_p, num_targets=1, num_task_specific_layers=2)  # NOTE
...
if finetune.state:
    from data.datasets import ExperimentalDataset, SynteticDataset
    ...
    # finetune.dataset = SynteticDataset(root=dataset_path,
                                    #    indices='datasets/PI_syn/100K_balanced_mol_ids.csv',
                                       target_name=finetune.target_name)
                                    # )
    finetune.epochs = epochs
    finetune.n_splits = 10
    # finetune.subset_size = 10_000  # NOTE
    # finetune.subset_size = 700
    
    # finetune.test_subset_size = 300
    # finetune.test_subset_size = 1000

    # finetune.save_preds = False
    finetune.save_preds = True  # NOTE

    finetune.val_freq = 1000
    ...
    # NOTE overwritten in finetune_multi_target.sh:
    finetune.optimizer_params = {"lr": 1e-3, "weight_decay": 1e-8}
