...
prefix = 'round_66'#_really_old_PI_exp_db'
...
dataset_path = "datasets/PI_syn_subset_100K"
...
if finetune.state:
    ...
    finetune.test_subset_size = 6400  # 6400 is for compatibility with previous results
