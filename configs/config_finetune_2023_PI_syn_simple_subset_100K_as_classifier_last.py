...
# prefix = 'round_115'#_really_old_PI_exp_db'
# prefix = 'round_133'#_really_old_PI_exp_db'
# prefix = 'round_150'  # label smoothing
# prefix = 'round_151'  # weight decay 1e-2
# prefix = 'round_152'  # lr 1e-4
prefix = 'round_200'
...
if finetune.state:
    ...
    finetune.subset_size = 100_000  # NOTE
