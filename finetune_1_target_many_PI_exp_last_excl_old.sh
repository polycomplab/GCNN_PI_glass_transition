...
#                       "5000_just_trained"
#                       )
# declare -a split_fixed_options=("True"
#                                 "False"
#                             )
pre_type="None"
# config_name="config_finetune_two_targets.py"
config_name="config_finetune_2023_PI_exp_last_excl_old.py"
declare -a learning_rates=("5e-5" "1e-4")
# declare -a learning_rates=("1e-4" "5e-4" "1e-3" "5e-3")
# declare -a num_epochs=("30" "60" "100")
# declare -a num_epochs=("10" "30" "100" "300")
declare -a num_epochs=("100" "300" "1000")
...
do
    ...
    do
        ...
        # for split_fixed in "${split_fixed_options[@]}"
        ...
        # python3.7 main.py configs/"$config_name" --lr="$learning_rate" --epochs="$e" --pre_type="$pre_type" --device_idx="$device_idx" --split_fixed="$split_fixed" 2>&1 | tee console_logs/$exp_name.txt &
