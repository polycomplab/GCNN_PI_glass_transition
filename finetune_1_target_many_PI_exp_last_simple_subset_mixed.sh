...
do
    ...
    do
        ...
        do
            ...
            python3.7 main.py configs/"$config_name" --loss2_weight="$w" --lr="$learning_rate" --epochs="$e" --pre_type="$pre_type" --device_idx="$device_idx" 2>&1 | tee console_logs/$exp_name.txt &
            # wait
